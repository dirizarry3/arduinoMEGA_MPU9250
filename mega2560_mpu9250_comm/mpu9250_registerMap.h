//Register map pulled from Sparkfun's library below
//
//SparkFun_MPU_9250-DMP_Arduino_Library
//
//I took this header out of efficiency. It was easier to copy and paste
//this file than go into the data sheet and write it up myself.
